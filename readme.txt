...
* Added contact ID to export file
...
* Update for compatibility with WP-CRM System core version 1.1.7 to include new allowed name prefixes.

= 1.1.0 =

* Included ability to assign contacts to categories
